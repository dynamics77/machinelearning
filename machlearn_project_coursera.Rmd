...
```
#Conclusions
Our results show that GBM model with tuned parameters when applied to exercise data that is not pre-processed using PCA gave very high accuracy close to 99% with out-of-sample error less than 1%.
